...
Given the code in \Vref{listing:elm_simple}, the list \texttt{user.functions} might contain \texttt{update} and \texttt{view}
...
Given the declaration of a value \texttt{john} with the type \texttt{Person} in \Vref{record_alias},
% \begin{minted}{elm}
...
\Vref{array_excerpt} shows parts of the first module entry from \texttt{elm/core}.
