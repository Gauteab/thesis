...
The format of the messages sent between server and client can be seen in Listing~\ref{listing:jsonrpc}, and
...
Listing~\ref{ex:value_and_function} shows two declarations.
...
\begin{code}{elm}{There \textit{Maybe} Union Type}{maybe}
type Maybe a
    = Just a
    | Nothing
\end{code}
