...
\end{enumerate}
Improvements to accuracy reduces the amount of misrecognition, which in turn
reduces the amount of time the user has to spend correcting those errors.
Improvements to interactions allows users to less to do more.
...
also outlines how to do with using LSP.
...
This section aims to answer the following research question:\newline
\textit{RQ1: How can the benefits of structural editors be achieved in text oriented environments for vocal programmers?}

\paragraph{}

The structural editing capabilities of the prototypes were quite rudimentary
...
Integrating with TreeSitter can be done the regular plug-ins
...
API for acquiring the locations of node given a name and/or type that can be
...
When conducting interviews the captured experience of users it is recommended to have
